...
|---------|--------------|-----------------|--------------------------------------------------------------------------|
| 0.1     | 2026-06-25   | ax-agent-spec   | First generation from developed PRD. P0 gate fired; user chose proceed with gaps. |
...
Per PRD, the following subagents (the PRD says "topics"; translated on
intake). Archetype tags are MISSING from the PRD and not invented here.
Routing descriptions and deterministic routing conditions are MISSING
from the PRD beyond high-level intent → subagent mapping.
...
|-----------|-----------|---------------|-----------------|
| 1.1       | flow      | unknown       | S-01            |
| 1.2       | prompt    | unknown       | S-01            |
| 1.3       | flow      | unknown       | S-01            |
| 1.4       | action    | unknown       | S-01            |
...
records is not a std. our customers follow."
...
PRD names both as OOTB platform features.
...
| Action ID | Mechanism | Exists today? | Spike (if not) |
|-----------|-----------|---------------|-----------------|
| 5.1       | flow      | unknown       | S-03            |
| 5.2       | flow      | unknown       | S-03            |
| 5.3       | flow      | unknown       | S-03            |
| 5.4       | prompt    | unknown       | S-03            |
| 5.5       | flow      | unknown       | S-03            |
| 5.6       | flow      | unknown       | S-03            |
...
Existing subagent per PRD; mechanism inherited.
